                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h1 mb-0 font-weight-bold text-white"><?= $this->ModelUser->getUserWhere(['id_role => 1'])->num_rows();?></div>
                            </div>
                            <div class="col-auto">
                                <a href="<?= base_url('user/anggota')?>"><i class="fas fa-user fa-3x text-warning"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="table-responsive table-bordered col-sm-5 ml-auto mr-auto mt-2">
                <div class="page-header">
                    ...
                    <a href="<?= base_url('user/data_user'); ?>" class="text-danger"><i class="fas fa-search mt-2 float-right">Tampilkan</i></a>
                </div>
            ...
            <div class="table-responsive table-bordered col-sm-5 ml-auto mr-auto mt-2">
                <div class="page-header">
                    <span class="fas fa-user text-primary mt-2">Data Buku</span>
                    <a href="<?= base_url('user/data_user'); ?>" class="text-danger"><i class="fas fa-search mt-2 float-right">Tampilkan</i></a>
                </div>
                <table class="table mt-3">
                    <thead>
